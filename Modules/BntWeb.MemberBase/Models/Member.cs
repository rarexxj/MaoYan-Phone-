    ...
    public class Member
    {
        ...
        public MemberExtension GetMemberExtension()
        {
            ...
            else
            {
                ...
                memberExtension.RealName = RealName;
                memberExtension.Qq = Qq;
                memberExtension.Weixin = Weixin;
                memberExtension.BirthType = BirthType;
                memberExtension.TastesType = TastesType;
                ...
                memberExtension.MemberCard = MemberCard;
            }

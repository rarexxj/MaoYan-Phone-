    ...
    public class EvaluateController : BaseApiController
    {
        ...
        public ApiResult Create(string sourceId, [FromBody] CreateEvaluateModel postEvaluate)
        {
            ...
            var evaluate = new Models.Evaluate()
            {
                ...
                GoodTasteScore=postEvaluate.GoodTasteScore,
                FreshMaterialScore = postEvaluate.FreshMaterialScore,
                DesMatchScore = postEvaluate.DesMatchScore,
                LogisticsScore = postEvaluate.LogisticsScore,

...
namespace BntWeb.OrderProcess.ViewModels
{
    public class RefundViewModel
    {
        ...
        public RefundViewModel(OrderRefund refund)
        {
            ...
            if (refund.SingleGoodsId != Guid.Empty)
            {
                goods =
                    currencyService.GetSingleByConditon<OrderGoods>(
                        a => a.OrderId == refund.OrderId && a.SingleGoodsId == refund.SingleGoodsId) ??
                    currencyService.GetSingleByConditon<OrderGoods>(
                            a => a.OrderId == refund.OrderId && a.GoodsId == refund.SingleGoodsId);
            }

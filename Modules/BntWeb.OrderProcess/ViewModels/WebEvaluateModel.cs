...
{
    public class WebEvaluateListModel
    {
        //退款上传凭证多张图片
        public string EvaluateImageIds { get; set; }
        /// <summary>
        ///  口感满意评分
        /// </summary>
        ...
        public List<WebEvaluateModel> Evaluates { get; set; }
    }
  
    public class WebEvaluateModel
    {/// <summary>
    /// 商品Id
    /// </summary>
    ...
    /// 评价详情
    /// </summary>
    public class WebEvaluateDetailsModel
    {
        /// <summary>
        /// 订单商品id
        /// </summary>

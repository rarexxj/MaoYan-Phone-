...
namespace BntWeb.Mall
{
    public class AdminMenu : INavigationProvider
    {
        ...
        private void BuildMenu(NavigationItemBuilder menu)
        {
            ...
            menu.Add(MallModule.Key + "-GoodsBrandList", "商品品牌", "10",
               item => item
                   .Action("List", "GoodsBrand", new { area = MallModule.Area })
                   .Permission(Permissions.ManageGoodsBrand)
               );

            menu.Add(MallModule.Key + "-SpecialGoodsList", "特殊商品", "10",
             item => item
                 .Action("SpecialList", "SpecialGoods", new { area = MallModule.Area })

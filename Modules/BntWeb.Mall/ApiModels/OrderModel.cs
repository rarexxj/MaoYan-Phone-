...
namespace BntWeb.Mall.ApiModels
{
    ...
    public class SubmitOrderModel
    {
        ...
        /// 自选商品
        /// </summary>
        public string OptGoods { get; set; }

        /// <summary>
        /// 立即购买商品
        /// </summary>
        public string NowBuyGoods { get; set; }
      
        /// <summary>
        /// 购物车商品
        /// </summary>
        public string CartGoods { get; set; }
        /// <summary>
        ///商品Id
        /// </summary>
        public Guid GoodId { get; set; }
        ...
        /// 自选商品所选数字
        /// </summary>
       public string OptionalMemo { get; set; }
        /// <summary>
        /// 收货地址的id
       ...
       public string GoodQuality { get; set;}
        ...
        /// 加价购数量
        /// </summary>
        public string PurQuality { get; set; }
    ...
    public class PurGoodsModel
    {
        public string id { get; set; }

        public int quantity { get; set; }
    }
    public class SingGoodsModel
    {
        public string id { get; set; }
    ...
    public class SimpleOderModel
    {
        ...
        public SimpleOderModel(Order order)
        {
            ...
            CouponMoney =(int)order.CouponMoney;
            PayFee = order.PayFee;

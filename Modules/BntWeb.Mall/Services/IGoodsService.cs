...
namespace BntWeb.Mall.Services
{
    public interface IGoodsService : IDependency
    {
        ...
        /// </summary>
        /// <returns></returns>
        List<Goods> GetOptionalGoods();
        /// <summary>
        /// 获得加价购商品
        /// </summary>
        /// <returns></returns>
        List<Goods> GePurchaseGoods();
        /// <summary>
        /// 加载完整单规格商品信息
        /// </summary>
        ...
        /// <returns></returns>
        List<Evaluate.Models.Evaluate> GetGoodsEvalListByPage(Guid goodsId, int pageIndex, int pageSize,
            out int totalCount);
        /// <summary>
        /// 保存商品
        /// </summary>
        ...
        /// <param name="totalCount"></param>
        /// <returns></returns>
        List<Goods> GetHotGoodsByCategory(Guid? categoryId, string keyword, GoodsSortType sortType, int pageIndex,
        ...
        /// <param name="goodsId"></param>
        /// <returns></returns>
        List<Evaluate.Models.Evaluate> GetGoodsEvaluatesList(Guid goodsId);
        /// <summary>
        /// 取新品商品
        /// </summary>
        /// <param name="pageIndex"></param>
        ...
        //添加收藏
        bool AddGoodsCollection(Guid goodsId, string memberId);


        //删除收藏
        bool DelGoodsCollection(Guid goodsId, string memberId);

        //获取商品收藏数量
        int GetCollectNumsByGoodsId(Guid goodsId);
        ...
        /// <param name="goodId"></param>
        /// <returns></returns>
        List<Goods> GeGoodPurchaseGoods(Guid goodId);
    }
}
...
namespace BntWeb.SinglePage.Services
{
    public class SinglePageService : ISinglePageService
    {
        ...
        public List<Models.SinglePage> GetListPaged<TKey>(int pageIndex, int pageSize,
        ...
        public List<Models.SinglePage> GetList(Expression<Func<Models.SinglePage, bool>> ex)
        {
            return _currencyService.GetList(ex);
        }
    }
}